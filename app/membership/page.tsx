...
export default function MembershipPage() {
  return (
    <>
      ...
      <section className="border-t border-white/6 bg-brand-black py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-none border-2 border-brand-pink bg-brand-card2 p-12 shadow-[0_0_0_1px_rgba(255,255,255,0.02)]">
            ...
            <h2 className="mt-6 font-display text-[42px] font-bold uppercase leading-[0.95] tracking-display text-white sm:text-[58px]">
              Get Our Best Rate Ever
            </h2>
            <p className="mt-4 max-w-3xl text-[16px] leading-[1.8] text-brand-light">
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-3">
              {[
                ...
                <div key={label} className="border border-white/10 bg-white/5 p-5">
                  ...
                  <div className="mt-2 font-display text-[34px] uppercase leading-none text-white">
                    {value}
                  </div>
                </div>
              ))}
      ...
      <section className="bg-brand-dark2 py-20 text-center">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-5 text-[16px] leading-[1.8] text-brand-light">

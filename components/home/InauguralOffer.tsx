      ...
      <div className="relative mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-4 md:grid-cols-2">
          <div className="border border-white/25 bg-white/15 p-5 text-center sm:p-7">
            ...
            <div className="mt-2 font-display text-[34px] leading-none text-white sm:text-[48px]">14,999</div>
          ...
          <div className="border border-white/25 bg-white/15 p-5 text-center sm:p-7">
            ...
            <div className="mt-2 font-display text-[34px] leading-none text-white sm:text-[48px]">9,999</div>
            <div className="mt-2 text-[12px] uppercase tracking-wide text-white/75 sm:text-[13px]">Per Year</div>
          </div>
        </div>
